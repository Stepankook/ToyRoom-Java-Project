...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("=================================================");
        System.out.println("🤖 Лабораторна робота 14: Ігрова Кімната");
        System.out.println("=================================================");
        ...
        // Ініціалізуємо репозиторій з тестовими даними
        InMemoryToyRepository repository = new InMemoryToyRepository();

        // Ініціалізуємо сервіс, передаючи йому репозиторій
        ...
        // Метод sortBy виводить результат безпосередньо в консоль
