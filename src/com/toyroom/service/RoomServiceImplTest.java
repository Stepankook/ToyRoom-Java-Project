...
import com.toyroom.domain.repo.InMemoryToyRepository; // Правильний шлях за твоїм скріншотом
...
public class RoomServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        // Використовуємо твій справжній репозиторій
    ...
    void testAutoPopulateLogic() {
        ...
        // ВИПРАВЛЕНО: викликаємо totalCost(), як у твоєму коді ToyRoom.java
